...
for i = 1, NUM_WPM do
    local key = i % 10
    hl.bind(mainMod .. " + SHIFT + " .. workspaceKeys[i], hl.dsp.window.move({ workspace = i }))
end
...
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd(launchPrefix .. "chromium"))
...
hl.bind("F8", hl.dsp.exec_cmd(home .. "/.local/bin/training-shot"))
